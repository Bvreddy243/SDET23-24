...
public class Calculator {
  ...
  public void  Calculator() throws MalformedURLException
  {
   ...
   driver.findElement(By.id("com.google.android.calculator:id/digit_9")).click();
	...
	driver.findElement(By.id("com.google.android.calculator:id/eq")).click();
	String text1= driver.findElement(By.id("com.google.android.calculator:id/result_final")).getText();
  ...
  driver.findElement(By.id("com.google.android.calculator:id/digit_8")).click();
	...
	driver.findElement(By.id("com.google.android.calculator:id/eq")).click();
	String text11= driver.findElement(By.id("com.google.android.calculator:id/result_final")).getText();
 ...
 driver.findElement(By.id("com.google.android.calculator:id/digit_8")).click();
	...
	driver.findElement(By.id("com.google.android.calculator:id/digit_5")).click();
	driver.findElement(By.id("com.google.android.calculator:id/eq")).click();
	String text111= driver.findElement(By.id("com.google.android.calculator:id/result_final")).getText();
